...
namespace asp_MVC_letsTry.Controllers
{
    public class loginFormController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Index(loginForm __loginForm)
        {
        ...
        //[HttpGet]
        public ActionResult loginGame(loginForm __loginForm)
        {
            /*var smth = new ship(4);
        ...
        [HttpPost]
        public JsonResult resFunc([FromBody]loginForm data) //[FromBody] обов'язково, бо без нього не працюєч
        {
